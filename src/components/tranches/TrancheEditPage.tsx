            ...
            <div className="p-8">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-5 mb-8">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-blue-900">Gestion des données maître</p>
                    <p className="text-sm text-blue-700 mt-1">
                      Les informations investisseur (nom, type) sont des données maître. Pour les
                      modifier, utilisez la gestion des investisseurs ou réassignez la souscription
