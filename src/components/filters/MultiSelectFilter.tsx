  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <button
        ...
        className="w-full px-3 py-2 border border-slate-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-finixar-brand-blue flex items-center justify-between text-left text-sm"
      >
      ...
      {selectedLabels.length > 0 && (
        <div className="flex flex-wrap gap-1 mt-2">
          ...
          <button
            onClick={onClear}
            className="text-xs text-finixar-red hover:text-red-700 px-2 py-1 hover:bg-red-50 rounded transition-colors"
          >
            Tout effacer
          </button>
        </div>
