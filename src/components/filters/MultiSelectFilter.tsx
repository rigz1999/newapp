  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <button
        ...
        className="w-full px-3 py-2 border border-slate-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-finixar-teal flex items-center justify-between text-left text-sm"
      >
