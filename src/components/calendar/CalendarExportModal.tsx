...
export function CalendarExportModal({
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      if (
        normalizedError.includes('no email connection') ||
        ...
        normalizedError.includes('calendar export is only supported') ||
        ...
        normalizedError.includes('failed to refresh') ||
        ...
        setError(errorMessage || "Une erreur est survenue lors de l'export");
      }
    } finally {
            ...
            {!success ? (
              <>
                ...
                <div className="mb-6 p-4 bg-gray-50 rounded-lg">
                  <h3 className="text-sm font-medium text-gray-700 mb-2">Vous allez exporter :</h3>
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="flex items-start gap-3">
                    <input
                      ...
                      onChange={e => setSettings({ ...settings, includePastDue: e.target.checked })}
                      className="mt-1 w-4 h-4 text-finixar-brand-blue border-gray-300 rounded focus:ring-finixar-brand-blue"
                    />
              ...
              <div className="text-center py-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Export réussi !</h3>
                <div className="text-sm text-gray-600 space-y-1 mb-6">
                  <p>
                    Total : {success.total} échéance{success.total > 1 ? 's' : ''}
                  </p>
                  {success.created > 0 && (
