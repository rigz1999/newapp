...
export function Layout({ organization }: LayoutProps) {
  ...
  return (
    <div className="h-screen bg-finixar-background flex overflow-hidden">
      <aside className="w-64 bg-finixar-navy text-white flex flex-col flex-shrink-0">
        <div className="p-6">
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-2.5 mb-6 bg-slate-800/50 hover:bg-finixar-purple rounded-lg transition-colors text-slate-400 hover:text-white"
          >
          ...
          <nav className="space-y-2">
            <Link
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${
                isActive('/') ? 'bg-finixar-purple text-white' : 'text-slate-300 hover:bg-finixar-purple hover:text-white'
              }`}
            >
            ...
            <Link
              to="/coupons"
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${
                isActive('/coupons') ? 'bg-finixar-purple text-white' : 'text-slate-300 hover:bg-finixar-purple hover:text-white'
              }`}
            >
            ...
            <Link
              to="/projets"
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${
                isActive('/projets') ? 'bg-finixar-purple text-white' : 'text-slate-300 hover:bg-finixar-purple hover:text-white'
              }`}
            >
            ...
            <Link
              to="/investisseurs"
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${
                isActive('/investisseurs') ? 'bg-finixar-purple text-white' : 'text-slate-300 hover:bg-finixar-purple hover:text-white'
              }`}
            >
            ...
            <Link
              to="/souscriptions"
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${
                isActive('/souscriptions') ? 'bg-finixar-purple text-white' : 'text-slate-300 hover:bg-finixar-purple hover:text-white'
              }`}
            >
            ...
            <Link
              to="/paiements"
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${
                isActive('/paiements') ? 'bg-finixar-purple text-white' : 'text-slate-300 hover:bg-finixar-purple hover:text-white'
              }`}
            >
            ...
            <Link
              to="/parametres"
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${
                isActive('/parametres') ? 'bg-finixar-purple text-white' : 'text-slate-300 hover:bg-finixar-purple hover:text-white'
              }`}
            >
            ...
            {isOrgAdmin && !isSuperAdminUser && (
              <>
                ...
                <Link
                  to="/membres"
                  className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${
                    isActive('/membres') ? 'bg-finixar-purple text-white' : 'text-slate-300 hover:bg-finixar-purple hover:text-white'
                  }`}
                >
              ...
              <>
                ...
                <Link
                  ...
                  className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-colors relative ${
                    isActive('/admin') ? 'bg-finixar-purple text-white' : 'text-slate-300 hover:bg-finixar-purple hover:text-white'
                  }`}
                >
                  <Shield className="w-5 h-5" />
                  <span>Admin Panel</span>
                  {pendingCount > 0 && (
                    <span className="absolute right-3 top-1/2 -translate-y-1/2 bg-finixar-red text-white text-xs font-bold rounded-full w-6 h-6 flex items-center justify-center">
                      {pendingCount}
                    </span>
                  )}
                </Link>
        ...
        <div className="mt-auto p-6 border-t border-slate-800">
          <div className="flex items-center gap-3 mb-4">
            <div className={`w-10 h-10 rounded-full flex items-center justify-center font-semibold ${
              isSuperAdminUser ? 'bg-finixar-purple' : isOrgAdmin ? 'bg-finixar-teal' : 'bg-finixar-purple'
            }`}>
