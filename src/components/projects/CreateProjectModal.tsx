...
import { Plus, X, Upload, FileSpreadsheet, ChevronDown, Loader2 } from 'lucide-react';
import { triggerCacheInvalidation } from '../../utils/cacheManager';
import { toast } from '../../utils/toast';
import { isValidSIREN } from '../../utils/validators';
import { formatMontantDisplay } from '../../utils/formatters';
...
export function CreateProjectModal({ organization, onClose }: CreateProjectModalProps) {
  ...
  const [newProjectData, setNewProjectData] = useState(INITIAL_FORM_DATA);
  ...
  const resetNewProjectForm = () => {
    setNewProjectData(INITIAL_FORM_DATA);
    setSirenError('');
    setSelectedOrgId('');
    resetImportState();
  };
              ...
              {isSuperAdmin && (
                <div>
                  ...
                  <p className="mt-1 text-xs text-slate-600">
                    Si aucune organisation n'est sélectionnée, le projet sera visible par tous les
                    utilisateurs
                  </p>
                </div>
              )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label
                    ...
                    className="block text-sm font-medium text-slate-900 mb-2"
                  >
                    Valeur nominale de l'obligation (€) <span className="text-finixar-red">*</span>
                  </label>
                  <input
                    id="valeur_nominale"
                    type="number"
              ...
              <div className="border-t border-slate-200 pt-4 mt-4">
                ...
                <div className="mt-4">
                  <label
                    ...
                    className="block text-sm font-medium text-slate-900 mb-2"
                  >
                    E-mail du représentant de la masse <span className="text-finixar-red">*</span>
                  </label>
                  <input
                    id="emailmasse"
