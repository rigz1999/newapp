            ...
            >
              <div className="p-6">
                <div className="flex items-start gap-4 mb-4">
                  <div className="bg-finxar-cta p-3 rounded-lg flex-shrink-0">
              ...
              <div className="bg-slate-50 px-6 py-3 flex gap-2 border-t border-slate-200">
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-finxar-cta text-white text-sm font-medium rounded-lg hover:bg-finxar-accent transition-colors"
                >
